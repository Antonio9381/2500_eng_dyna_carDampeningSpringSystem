...
Then, the model was validated by simplifying the problem to drive on a flat road, and see how the system reacted. As shown in Figure \ref{} and \ref{}, the car is stable, which is what is expected on a flat road.