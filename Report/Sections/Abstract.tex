...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        Naimish Aggarwal & 550725262 & Initial planning, derivations and math and worked on majority of the report \\
        \hline
        Isaac Edmonds & 550813846 & Worked on coding and results of the report \\
        \hline
        Tung Ling Wu & INSERT SID & Did the majority of the code simulation\\
        \hline
    \end{tabular}
\end{table}
